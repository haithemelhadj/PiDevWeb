...
final class LieuController extends AbstractController
{
    ...
    #[Route('/{lieuId}', name: 'app_lieu_show', methods: ['GET'])]
    ...
    #[Route('/{lieuId}/edit', name: 'app_lieu_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{lieuId}', name: 'app_lieu_delete', methods: ['POST'])]
    public function delete(Request $request, Lieu $lieu, EntityManagerInterface $entityManager): Response
    {
        if ($this->isCsrfTokenValid('delete'.$lieu->getLieuId(), $request->getPayload()->getString('_token'))) {
