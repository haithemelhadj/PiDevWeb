...
final class QuestionsController extends AbstractController
{
    ...
    #[Route('/{qid}', name: 'app_questions_show', methods: ['GET'])]
    ...
    #[Route('/{qid}/edit', name: 'app_questions_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{qid}', name: 'app_questions_delete', methods: ['POST'])]
    public function delete(Request $request, Questions $question, EntityManagerInterface $entityManager): Response
    {
        if ($this->isCsrfTokenValid('delete'.$question->getQid(), $request->getPayload()->getString('_token'))) {
